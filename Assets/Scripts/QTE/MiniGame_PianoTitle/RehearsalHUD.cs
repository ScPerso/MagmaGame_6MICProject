...
/// <summary>
/// Temporary in-game HUD drawn with IMGUI. It shows the running score and spawns a
/// short-lived, color-coded judgement label at each note's position. Throwaway
/// placeholder UI meant to be replaced by a proper HUD later.
/// </summary>
...
public class RehearsalHUD : MonoBehaviour
{
    ...
    private void OnNoteJudged(JudgementResult result, Vector3 worldPosition)
    {
    ...
    private static string GetLabel(JudgementResult result)
    {
        switch (result)
        {
    ...
    private static Color GetColor(JudgementResult result)
    {
        switch (result)
        {
            case JudgementResult.Perfect:
